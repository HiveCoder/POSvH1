...
import { updateWebsiteOrder } from '../lib/website-mock';
...
const PaymentDialog: React.FC<PaymentDialogProps> = ({
  ...
  const vatSplit = splitVatInclusive(finalTotal);
  ...
  const handlePayment = async () => {
    ...
    try {
      if (IS_WEBSITE_MODE) {
        updateWebsiteOrder(invoice, {
          status: 'Paid',
          rounded_total: finalTotal,
          ...
          discount_percentage: discountValue ? parseInt(discountValue) : 0,
        });
      } else {
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between text-gray-600">
                ...
                <span>{formatCurrency(vatSplit.vatableSales)}</span>
              </div>
              <div className="flex justify-between text-gray-600">
                <span>VAT (12%)</span>
                <span>{formatCurrency(vatSplit.vatAmount)}</span>
              </div>
